...
#lens
l1_f = 125.4                   #focal length of the L1 lens (l1_f = 0 for calcu)
...
# d = obj_f+d_fpp 
# if d < d_fpoint_to_objlens: 
  #  print("Distance from objective lens to L1 focal point is less than " + str(d_fpoint_to_objlens) + " mm")
  #  file.write("- Distance from objective lens to L1 focal point does not fit the constraint. It is less than " + str(round(d_fpoint_to_objlens, 4)) + " mm \n")
    
    
# elif d >= d_fpoint_to_objlens: 
  #  print("Distance from objective lens to L1 focal point is " + str(d) + " mm")
   # file.write("- Distance from objective lens to L1 focal point fits the constraint: " + str(round(d, 4)) + " mm \n")
...
if l1_f == 0:  
    ...
    if dd >= d_l1_to_objlens:
        ...
        print("Calculated focal length: " + str(l1_f) + " mm")
      #  print("Needs to be at least " + str(dd-d_fpp-obj_f))
      ...
      #  file.write("    - Needs to be at least: " + str(round(dd-d_fpp-obj_f, 4)) + " mm \n")
