# -*- coding: utf-8 -*-
"""
Marzo L.C. - NAS group - Chemical Physics - Lund University  
August 2024
...
d_tl1_to_tl2 = 200.0                    #distance between the telescope lenses
...
#lenses 
lens_tube_f = 301.1                      #focal length of tube lens 
lens_tl1_bf = 46.2                      #back focal length of telescope lens 1
lens_tl2_f =  175.6                          #focal length of telescope lens 2
...
if lens_tube_f == 0 and lens_tl1_bf == 0 and lens_tl2_f == 0: 
    ...
    new_file_name = file_name + "_obtain_ss_" + str(s_size).replace(".", "_") + "_mag1_" + str(mag_tube).replace(".", "_") + "_sls_" + str(spec_slit_size).replace(".", "_") + "_dtot_" + str(d_total).replace(".", "_") + ".txt"
...
#given set-up parameteres and constraints
    ...
    new_file_name = file_name + "_check_fTUBE_" + str( round(lens_tube_f, 2) ).replace(".", "_") + "_bfTL1_" + str( round(lens_tl1_bf, 2) ).replace(".", "_") + "_fTL2_" + str( round(lens_tl2_f, 2) ).replace(".", "_") + ".txt"
